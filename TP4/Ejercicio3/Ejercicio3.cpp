...
int main() {
	cout<<"Invococi�n al constructor por defecto"<<endl;
	CuentaObjeto obj1;
	...
	{
		cout<<"Invocaci�n al constructor copia"<<endl;
		CuentaObjeto obj2(obj1);
		cout<<"(Fin constructor copia)"<<endl;
		cout<<endl<<"   2� Resumen"<<endl;
		CuentaObjeto::mostrarResumen();

		cout<<"Invocaci�n al constructor por defecto a trav�s del operador NEW"<<endl;
		CuentaObjeto *obj3 = new CuentaObjeto();
		cout<<"(Fin constructor por defecto)"<<endl;
		cout<<endl<<"   3� Resumen"<<endl;
		CuentaObjeto::mostrarResumen();

		cout<<"Invocaci�n a la funci�n miembro metodo1"<<endl;
		obj1 = obj2.metodo1(obj1);
		cout<<"(Fin metodo1)"<<endl;
		cout<<endl<<"   4� Resumen"<<endl;
		CuentaObjeto::mostrarResumen();

		cout<<"Invocaci�n a la funci�n miembro metodo2"<<endl;
